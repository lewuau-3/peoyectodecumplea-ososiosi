...
const far = new StarField($("#starCanvasFar"), preset.far, .35, [210, 229, 248]);
const mid = new StarField($("#starCanvasMid"), preset.mid, .75, [225, 240, 255]);
const near = new StarField($("#starCanvasNear"), preset.near, 1.25, [242, 249, 255]);
...
const galaxy = new GalaxyEngine($("#galaxyCanvas"), tier);
