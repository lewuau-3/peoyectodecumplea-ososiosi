export class StarField {
  constructor(canvas, count, depth, tint = [230, 244, 255], options = {}) {
    this.canvas = canvas;
    ...
    this.mood = "sleeping";
    this.running = true;
    this.pixelRatio = options.pixelRatio || 1.25;
    this.frameInterval = options.frameInterval || 0;
    this.lastFrame = 0;
  ...
  draw = () => {
    ...
    if (this.frameInterval && now - this.lastFrame < this.frameInterval) {
